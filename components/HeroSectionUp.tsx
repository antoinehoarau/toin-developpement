  ...
  return (
    ...
    >
      <div className="basis-1/2 md:px-2 py-10 h-full flex flex-col justify-around items-center">
        <div>
          <h2 className="h-32 sm:h-40 md:h-44 lg:h-52 w-52 sm:w-[800px] text-4xl font-extrabold uppercase max-w-sm sm:text-5xl md:text-5xl lg:text-6xl lg:max-w-lg xl:text-7xl xl:max-w-xl">
            <Typewriter
              options={{
                autoStart: true,
                loop: true,
              ...
              onInit={(typewriter) => {
                typewriter
                  .changeDelay(30)
                  .pauseFor(1000)
                  .typeString('Création de site web')
                  .pauseFor(2000)
                  .deleteAll()
                  .pauseFor(300)
                  .typeString("Développeur d'application Web")
                  .pauseFor(2000)
                  .deleteChars(3)
                  .changeDelay(100)
                  .typeString('Mobile')
