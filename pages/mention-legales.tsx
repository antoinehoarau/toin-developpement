...
export default function Mention() {
  return (
    <div className="flex flex-col font-nun min-h-screen items-start mt-40 w-full md:w-4/6 justify-center p-6">
      <Head>
        <title>Mention Legals - Toin Développement</title>
        <meta
          name="description"
          content="Mention Legals - Toin développement est une agence qui développe des applications web,
            Mobile, bureautique et site internet."
        />
        <meta name="robots" content="index, follow" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <h2 className="text-5xl text-center font-bold mt-5">
        Mention légales
      </h2>
      <h2 className="text-3xl font-bold mt-5">Définitions</h2>
      <p>
        ...
        <a href="https://www.toin-developpement.fr/">
          https://www.toin-developpement.fr/
        </a>{' '}
      ...
      <p>
        <strong>Propriétaire</strong> : Antoine HOARAU – 47 chemin Gonneau
        La plaine 97411 Saint-Paul
        <br />
        <strong>Responsable publication</strong> : Antoine HOARAU –
        info@toin-developpement.fr
        <br />
        Le responsable publication est une personne physique ou une
        personne morale.
        <br />
        <strong>Webmaster</strong> : Antoine HOARAU –
        info@toin-developpement.fr
        <br />
        <strong>Hébergeur</strong> : Vercel Inc. – 340 S Lemon Ave #4133 ,
        CA 91789 Walnut privacy@vercel.com
        <br />
        <strong>Délégué à la protection des données</strong> : Antoine
        HOARAU – info@toin-developpement.fr
        <br />
      </p>
      ...
      <p>
        ...
        de virus et avec un navigateur de dernière génération mis-à-jour Le
        site{' '}
        <a href="https://www.toin-developpement.fr/">
          https://www.toin-developpement.fr/
        </a>{' '}
      ...
      <p>
        ...
        est représenté par Antoine HOARAU, son représentant légal
      </p>
      <p>
        ...
        l’exactitude et de la pertinence des Données Personnelles au regard
      ...
      Antoine HOARAU – DPO, Antoine HOARAU <br />
      47 chemin Gonneau La plaine 97411 Saint-Paul.
      <p>
      ...
      <p>
        ...
        utilisateurs concernés afin qu&apos;ils puissent prendre les
        ...
        informer pleinement nos clients de toutes les questions relevant de
      ...
      <p>
        ...
        sont enregistrés, l’Utilisateur est informé que sa navigation et
      ...
      <p>
        ...
        ouverte et les informations consultées), ainsi que l’utilisation de
        ce Site par l’Utilisateur.{' '}
      </p>
      <p>
      ...
      <p>
        ...
        tribunaux compétents de Saint-Paul
      </p>
    </div>
  )
}
